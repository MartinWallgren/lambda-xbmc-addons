...
class index:
    ...
    def getMovieItem(self, total, i, autoplay, playbackMenu, action, getmeta, favRead):
        try:
    ...
    def movieList(self, movieList):
        ...
        threads = []
        for i in movieList:
            threads.append(Thread(self.getMovieItem, total, i, autoplay, playbackMenu, action, getmeta, favRead))
